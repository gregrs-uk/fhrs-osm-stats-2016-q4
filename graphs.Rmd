...
top.matches.pc.mtx <- t(as.matrix(top.matches.pc[,c("FHRS_matched_pc","FHRS_pcode_err_pc")],
                                  dimnames = c(row.names(top.matches.pc),
                                               colnames(top.matches.pc))))
...
barplot(top.matches.pc.mtx[,10:1], names.arg = colnames(top.matches.pc.mtx)[10:1],
        horiz=T, las=1, col = c("#c0c0ff","#ffc0c0"),
        main="Top 10: % of FHRS establishments matched",
        xlab="% of FHRS establishments matched with/without valid postcode")
```

Blue = Establishments with a matching FHRS ID and postcode<br>
Red = Establishments with a matching FHRS ID but mismatched/missing postcode
