...
old <- read.csv("~/Desktop/fhrs-stats/stats-2016-10-11-plus-haringey.csv", row.names=2)
new <- read.csv("~/Desktop/fhrs-stats/stats-2016-11-15.csv", row.names=2)
...
barplot(progress.numbers,
        ...
        legend.text=T, args.legend = list(x=2.25, y=2.1, bty="n", cex=0.9))
```
