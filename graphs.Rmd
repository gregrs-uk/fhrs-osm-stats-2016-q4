...
pie.numbers <- data.frame(districts = c(no.match.districts,
                                        new.match.districts,
...
## Districts with at least one match

```{r plot-pie, echo=F}
# pie chart of districts with at least one match
par(mai=c(0.75,0.75,0.75,0.75))
lbls = paste(row.names(pie.numbers), " (", pie.numbers$districts, ")", sep="")
pie(pie.numbers$districts,
    labels = lbls,
